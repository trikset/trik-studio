...
/// Thrown when given source file name is not found by decompressor. It probably means that save file name is wrong.
class QRREPO_EXPORT SaveFileNotFoundException : public QrRepoException
{
public:
