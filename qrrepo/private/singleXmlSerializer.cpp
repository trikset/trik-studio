	...
	QHash<qReal::Id, Object *> const &objects)
{
	...
	const auto *const graphicalObject = dynamic_cast<const GraphicalObject *>(objects[diagramId]);
	if (graphicalObject) {
	...
	QHash<qReal::Id, Object *> const &objects)
{
	...
	const auto *const graphicalObject = dynamic_cast<const GraphicalObject *>(objects[id]);
	if (graphicalObject) {
