...
cp -f     $BIN_DIR/plugins/tools/kitPlugins/librobots-trik-v62-interpreter.dylib              "$BUNDLE_CONTENTS/Lib/plugins/tools/kitPlugins/"
cp -f    $BIN_DIR/plugins/tools/kitPlugins/librobots-trik-v62-qts-generator.dylib            "$BUNDLE_CONTENTS/Lib/plugins/tools/kitPlugins/"
