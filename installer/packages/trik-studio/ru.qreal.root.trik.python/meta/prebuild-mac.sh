...
rsync -a   "$BIN_DIR"/librobots-trik-python-generator-library*.dylib                          "$BUNDLE_CONTENTS/Lib/"
...
rsync -a   "$BIN_DIR"/plugins/tools/kitPlugins/librobots-trik-v62-python-generator.dylib    "$BUNDLE_CONTENTS/Lib/plugins/tools/kitPlugins/"
