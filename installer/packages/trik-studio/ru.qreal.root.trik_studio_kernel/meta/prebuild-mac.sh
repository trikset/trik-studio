...
cp -fp   $BIN_DIR/plugins/editors/librobotsMetamodel.dylib                   "$BUNDLE_CONTENTS/Lib/plugins/editors/"
cp -fp   $BIN_DIR/plugins/tools/librobots-plugin.dylib                       "$BUNDLE_CONTENTS/Lib/plugins/tools/"
