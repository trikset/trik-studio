...
rsync -a   "$BIN_DIR"/plugins/editors/libnxtMetamodel.dylib                                      "$BUNDLE_CONTENTS/Lib/plugins/editors/"
rsync -a   "$BIN_DIR"/plugins/tools/kitPlugins/librobots-nxt-interpreter.dylib                   "$BUNDLE_CONTENTS/Lib/plugins/tools/kitPlugins/"
