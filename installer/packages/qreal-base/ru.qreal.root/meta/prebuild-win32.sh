...
cp    "$QT_PLUGINS"/platforms/q{windows,offscreen,minimal}.dll    "$PWD/../data/platforms"
cp    "$QT_PLUGINS"/imageformats/q{svg,jpeg}.dll                  "$PWD/../data/imageformats"
cp    "$QT_PLUGINS"/iconengines/qsvgicon.dll                      "$PWD/../data/iconengines"
