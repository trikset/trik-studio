...
cp -fpR $BIN_DIR/libqrgraph*.dylib                                         "$BUNDLE_CONTENTS/Lib"
cp -fpR $BIN_DIR/libqrrepo*.dylib                                          "$BUNDLE_CONTENTS/Lib"
cp -fpR "$BIN_DIR/patcher"                                                 "$BUNDLE_CONTENTS/MacOS/"
...
cp -fpR $BIN_DIR/libqrgui-editor*.dylib                                    "$BUNDLE_CONTENTS/Lib"
cp -fpR $BIN_DIR/libqrgui-hotkey-manager*.dylib                            "$BUNDLE_CONTENTS/Lib"
cp -fpR $BIN_DIR/libqrgui-models*.dylib                                    "$BUNDLE_CONTENTS/Lib"
cp -fpR $BIN_DIR/libqrgui-mouse-gestures*.dylib                            "$BUNDLE_CONTENTS/Lib"
cp -fpR $BIN_DIR/libqrgui-plugin-manager*.dylib                            "$BUNDLE_CONTENTS/Lib"
cp -fpR $BIN_DIR/libqrgui-meta-meta-model*.dylib                           "$BUNDLE_CONTENTS/Lib"
cp -fpR $BIN_DIR/libqrgui-preferences-dialog*.dylib                        "$BUNDLE_CONTENTS/Lib"
cp -fpR $BIN_DIR/libqrgui-text-editor*.dylib                               "$BUNDLE_CONTENTS/Lib"
...
fix_qreal_dependencies "$BUNDLE_CONTENTS/Lib/libqscintilla2.15.0.0.dylib"
...
fix_qreal_dependencies "$BUNDLE_CONTENTS/MacOS/platforms/libqminimal.dylib"       "$QT_LIB" "$LIB_PATH"
fix_qreal_dependencies "$BUNDLE_CONTENTS/MacOS/platforms/libqoffscreen.dylib"       "$QT_LIB" "$LIB_PATH"
fix_qreal_dependencies "$BUNDLE_CONTENTS/MacOS/platforms/libqcocoa.dylib"       "$QT_LIB" "$LIB_PATH"
fix_qreal_dependencies "$BUNDLE_CONTENTS/MacOS/imageformats/libqsvg.dylib"      "$QT_LIB" "$LIB_PATH"
fix_qreal_dependencies "$BUNDLE_CONTENTS/MacOS/imageformats/libqjpeg.dylib"      "$QT_LIB" "$LIB_PATH"
fix_qreal_dependencies "$BUNDLE_CONTENTS/MacOS/iconengines/libqsvgicon.dylib"   "$QT_LIB" "$LIB_PATH"
