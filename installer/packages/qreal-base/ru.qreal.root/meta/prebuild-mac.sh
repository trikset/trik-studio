...
cp -fP $(pkg-config --variable=libdir zlib)/libz*.dylib                       "$BUNDLE_CONTENTS/Lib"
...
fix_qreal_dependencies "$BUNDLE_CONTENTS/Lib/libqscintilla2.15.0.dylib"
fix_qreal_dependencies "$BUNDLE_CONTENTS/Lib/libtrikQsLog.1.0.0.dylib"
