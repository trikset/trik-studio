...
QMessageBox::StandardButton utils::QRealMessageBox::question(QWidget *parent, const QString &title, const QString &text,
	QMessageBox::StandardButtons buttons)
{
	...
	if (buttons & QMessageBox::Open) {
		messageBox->setButtonText(QMessageBox::Open, tr("Open"));
	}
	...
	if (buttons & QMessageBox::Apply) {
		messageBox->setButtonText(QMessageBox::Apply, tr("Apply"));
	}
	if (buttons & QMessageBox::Reset) {
		messageBox->setButtonText(QMessageBox::Reset, tr("Reset"));
	}
	if (buttons & QMessageBox::Help) {
		messageBox->setButtonText(QMessageBox::Help, tr("Help"));
	}
	if (buttons & QMessageBox::SaveAll) {
		messageBox->setButtonText(QMessageBox::SaveAll, tr("Save All"));
	}
	if (buttons & QMessageBox::Yes) {
		messageBox->setButtonText(QMessageBox::Yes, tr("Yes"));
	}
	if (buttons & QMessageBox::YesToAll) {
		messageBox->setButtonText(QMessageBox::YesToAll, tr("Yes To All"));
	}
	if (buttons & QMessageBox::No) {
		messageBox->setButtonText(QMessageBox::No, tr("No"));
	}
	if (buttons & QMessageBox::NoToAll) {
		messageBox->setButtonText(QMessageBox::NoToAll, tr("No To All"));
	}
	if (buttons & QMessageBox::Abort) {
		messageBox->setButtonText(QMessageBox::Abort, tr("Abort"));
	}
	if (buttons & QMessageBox::Retry) {
		messageBox->setButtonText(QMessageBox::Retry, tr("Retry"));
	}
	if (buttons & QMessageBox::Ignore) {
		messageBox->setButtonText(QMessageBox::Ignore, tr("Ignore"));
	}
	if (buttons & QMessageBox::NoButton) {
		messageBox->setButtonText(QMessageBox::NoButton, tr("NoButton"));
	}
