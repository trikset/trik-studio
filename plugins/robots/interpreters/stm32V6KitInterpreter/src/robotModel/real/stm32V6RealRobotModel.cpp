...
#include "stm32V6RealRobotModel.h"

#include <qrkernel/settingsManager.h>
#include <qrkernel/exception/exception.h>

#include <stm32KitInterpreterCommon/robotModel/real/parts/display.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/speaker.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/button.h>

#include <stm32KitInterpreterCommon/robotModel/real/parts/powerMotor.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/powerMotorsAggregator.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/servoMotor.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/encoderSensor.h>

#include <stm32KitInterpreterCommon/robotModel/real/parts/touchSensor.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/lightSensor.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/infraredSensor.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/sonarSensor.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/motionSensor.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/gyroscope.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/accelerometer.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/colorSensor.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/led.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/lineSensor.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/objectSensor.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/shell.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/gamepadButton.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/gamepadConnectionIndicator.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/gamepadPad.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/gamepadPadPressSensor.h>
#include <stm32KitInterpreterCommon/robotModel/real/parts/gamepadWheel.h>

#include <utils/robotCommunication/networkCommunicationErrorReporter.h>

using namespace stm32::robotModel::real;
using namespace kitBase::robotModel;

Stm32V6RealRobotModel::Stm32V6RealRobotModel(const QString &kitId, const QString &robotId)
	: Stm32RobotModelV6(kitId, robotId)
	, mRobotCommunicator(new utils::robotCommunication::TcpRobotCommunicator("Stm32TcpServer"))
{
	connect(mRobotCommunicator.data(), &utils::robotCommunication::TcpRobotCommunicator::connected
			, this, &Stm32V6RealRobotModel::connected);
	connect(mRobotCommunicator.data(), &utils::robotCommunication::TcpRobotCommunicator::disconnected
			, this, &Stm32V6RealRobotModel::disconnected);
}

QString Stm32V6RealRobotModel::name() const
{
	return "Stm32RealRobotModel";
}

QString Stm32V6RealRobotModel::friendlyName() const
{
	return tr("Interpretation (Wi-Fi)");
}

int Stm32V6RealRobotModel::priority() const
{
	return 8;  // Right after qts generator
}

void Stm32V6RealRobotModel::updateSensorsValues() const
{
	mRobotCommunicator.data()->requestData();
}

bool Stm32V6RealRobotModel::needsConnection() const
{
	return true;
}

void Stm32V6RealRobotModel::connectToRobot()
{
	mRobotCommunicator->connect();
}

void Stm32V6RealRobotModel::stopRobot()
{
	mRobotCommunicator->stopRobot();
}

void Stm32V6RealRobotModel::disconnectFromRobot()
{
	mRobotCommunicator->disconnect();
}

void Stm32V6RealRobotModel::setErrorReporter(qReal::ErrorReporterInterface &errorReporter)
{
...
robotParts::Device *Stm32V6RealRobotModel::createDevice(const PortInfo &port, const DeviceInfo &deviceInfo)
{
