...
void Motor::on(int speed, uint64_t degrees, bool breakMode)
{
	...
	setOutputState(speed, mode, enums::regulationMode::REGULATION_MODE_MOTOR_SPEED, 100,
		enums::runState::MOTOR_RUN_STATE_RUNNING, degrees);
}
...
void Motor::off()
{
	setOutputState(0, enums::motorMode::REGULATED, enums::regulationMode::REGULATION_MODE_MOTOR_SPEED, 100,
		enums::runState::MOTOR_RUN_STATE_IDLE, 0);
}

void Motor::setOutputState(int speed, int mode, enums::regulationMode::RegulationModeEnum regulation, int turnRatio,
