...
TwoDMotor::TwoDMotor(const kitBase::robotModel::DeviceInfo &info, const kitBase::robotModel::PortInfo &port,
...
void TwoDMotor::on(int speed, uint64_t degrees, bool breakMode)
{
