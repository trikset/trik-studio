...
using namespace stm32::robotModel::real::parts;
using namespace kitBase::robotModel;

Display::Display(const DeviceInfo &info, const PortInfo &port
		, utils::robotCommunication::TcpRobotCommunicator &tcpRobotCommunicator)
	: robotModel::parts::Stm32Display(info, port)
...
{
	const QString pathToCommand = sad ? ":/stm32Qts/templates/drawing/sadSmile.t"
			: ":/stm32Qts/templates/drawing/smile.t";
...
{
	const QString pathToCommand = ":/stm32Qts/templates/drawing/setBackground.t";
	const QString directCommand = utils::InFile::readAll(pathToCommand)
...
{
	const QString pathToCommand = ":/stm32Qts/templates/drawing/clearScreen.t";
...
{
	const QString pathToCommand = ":/stm32Qts/templates/drawing/printText.t";
...
void Display::redraw()
{
	const QString pathToCommand = ":/stm32Qts/templates/drawing/redraw.t";
	const QString directCommand = utils::InFile::readAll(pathToCommand);
	mRobotCommunicator.runDirectCommand(directCommand);
}
