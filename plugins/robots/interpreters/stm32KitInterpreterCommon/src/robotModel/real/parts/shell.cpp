...
Shell::Shell(const DeviceInfo &info, const PortInfo &port
	...
	: robotModel::parts::Stm32Shell(info, port)
...
{
	const QString pathToCommand = ":/stm32Qts/templates/say.t";
...
{
	const QString pathToCommand = ":/stm32Qts/templates/system.t";
	const QString directCommand = utils::InFile::readAll(pathToCommand)
...
{
	const QString pathToCommand = ":/stm32Qts/templates/files/writeFile.t";
	const QString directCommand = utils::InFile::readAll(pathToCommand)
...
{
	const QString pathToCommand = ":/stm32Qts/templates/files/removeFile.t";
	const QString directCommand = utils::InFile::readAll(pathToCommand)
...
{
	const QString pathToCommand = ":/stm32Qts/templates/functions/print.t";
	const QString directCommand = utils::InFile::readAll(pathToCommand)
