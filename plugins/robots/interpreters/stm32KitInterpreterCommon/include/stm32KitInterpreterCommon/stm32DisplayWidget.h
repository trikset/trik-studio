...
namespace Ui {
class Stm32DisplayWidget;
}

namespace stm32 {

class ROBOTS_STM32_KIT_INTERPRETER_COMMON_EXPORT Stm32DisplayWidget : public twoDModel::engine::TwoDModelDisplayWidget
{
	Q_OBJECT

public:
	explicit Stm32DisplayWidget(QWidget *parent = nullptr);
	~Stm32DisplayWidget();
