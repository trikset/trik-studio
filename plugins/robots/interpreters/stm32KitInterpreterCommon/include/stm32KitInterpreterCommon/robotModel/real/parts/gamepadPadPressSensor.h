...
/// Implementation of STM32 Android gamepad pad as button for interpretation mode on real robot.
class ROBOTS_STM32_KIT_INTERPRETER_COMMON_EXPORT GamepadPadPressSensor
		: public robotModel::parts::Stm32GamepadPadPressSensor
{
	Q_OBJECT
