...
/// Implementation of STM32 Android gamepad wheel for interpretation mode on real robot.
class ROBOTS_STM32_KIT_INTERPRETER_COMMON_EXPORT GamepadWheel : public robotModel::parts::Stm32GamepadWheel
{
	Q_OBJECT
