...
/// Implementation of STM32 Android gamepad pad for interpretation mode on real robot.
class ROBOTS_STM32_KIT_INTERPRETER_COMMON_EXPORT GamepadPad : public robotModel::parts::Stm32GamepadPad
{
	Q_OBJECT
