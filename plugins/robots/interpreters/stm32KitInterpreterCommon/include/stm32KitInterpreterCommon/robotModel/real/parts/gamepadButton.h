...
/// Implementation of STM32 Android gamepad button for interpretation mode on real robot.
class ROBOTS_STM32_KIT_INTERPRETER_COMMON_EXPORT GamepadButton: public robotModel::parts::Stm32GamepadButton
{
	Q_OBJECT
