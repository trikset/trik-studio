...
/// Implementation of STM32 Android gamepad connection indicator for interpretation mode on real robot.
class ROBOTS_STM32_KIT_INTERPRETER_COMMON_EXPORT GamepadConnectionIndicator
		: public robotModel::parts::Stm32GamepadConnectionIndicator
{
	Q_OBJECT
