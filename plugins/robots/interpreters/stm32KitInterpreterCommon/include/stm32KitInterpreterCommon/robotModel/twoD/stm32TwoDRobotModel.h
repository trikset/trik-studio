...
///       So, for different STM32 cases devices are the same, but mappings between ports and devices are
...
class ROBOTS_STM32_KIT_INTERPRETER_COMMON_EXPORT Stm32TwoDRobotModel : public twoDModel::robotModel::TwoDRobotModel
{
	Q_OBJECT

public:
	explicit Stm32TwoDRobotModel(kitBase::robotModel::RobotModelInterface &realModel);
