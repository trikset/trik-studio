...
void Ev3InputDevice::send(const QByteArray &command, const unsigned responseSize, QByteArray reading)
{
...
{
	QByteArray command =
		Ev3DirectCommand::formCommand(21, 2, 4, 0, enums::commandType::CommandTypeEnum::DIRECT_COMMAND_REPLY);
	int index = 7;
