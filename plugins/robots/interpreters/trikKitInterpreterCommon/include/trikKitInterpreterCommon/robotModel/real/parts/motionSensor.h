...
class ROBOTS_TRIK_KIT_INTERPRETER_COMMON_EXPORT MotionSensor : public robotModel::parts::TrikMotionSensor
{
	Q_OBJECT

public:
	MotionSensor(const kitBase::robotModel::DeviceInfo &info, const kitBase::robotModel::PortInfo &port,
