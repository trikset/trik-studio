...
class ROBOTS_TRIK_KIT_INTERPRETER_COMMON_EXPORT GamepadWheel : public robotModel::parts::TrikGamepadWheel
{
	Q_OBJECT
...
public:
	...
	///        service on a robot.
	GamepadWheel(const kitBase::robotModel::DeviceInfo &info, const kitBase::robotModel::PortInfo &port,
