...
class ROBOTS_TRIK_KIT_INTERPRETER_COMMON_EXPORT GamepadPad : public robotModel::parts::TrikGamepadPad
{
	Q_OBJECT
...
public:
	...
	///        service on a robot.
	GamepadPad(const kitBase::robotModel::DeviceInfo &info, const kitBase::robotModel::PortInfo &port,
