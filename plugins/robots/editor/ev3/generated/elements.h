...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDescription(QObject::tr("Plays on the robot a sound with the fixed frequency. There are two "
		                           "parameters. The first one is a loudness of the sound, the second means if "
		                           "program should wait for sound completion or go to next block right away."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 1.2, -0.7, "Volume", false, 0));
		...
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1.4, 1.2, "WaitForCompletion", false, 0));
	...
	void initProperties()
	{
		...
		addProperty("WaitForCompletion", "bool", QString::fromUtf8("true"), QObject::tr("Wait for Completion"),
			QObject::tr(""), false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Calibrates the black threshold for each sensor in the array. Place the "
		                           "array over the black surface with all sensors on the black area."));
		QSharedPointer<qReal::LabelProperties> label_1(
		...
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3CalibrateBlackLLClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
	...
	void initProperties()
	{
		addProperty("Port", "Ev3SensorPort", QString::fromUtf8("1"), QObject::tr("Port"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		label_1->setPrefix(QObject::tr("Port:"));
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3CalibrateGyroscopeClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Sets set point, P, I, D value of PID control and P factor, I factor, D "
		                           "factor for P, I, D value of PID control."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.9, 1.2, "SetPoint", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		QSharedPointer<qReal::LabelProperties> label_4(
			new qReal::LabelProperties(4, 0.9, 2.4, "PFactor", false, 0));
		...
		QSharedPointer<qReal::LabelProperties> label_6(
			new qReal::LabelProperties(6, 0.9, 3.6, "IFactor", false, 0));
		...
		addLabel(label_7);
		QSharedPointer<qReal::LabelProperties> label_8(
			new qReal::LabelProperties(8, 0.9, 4.8, "DFactor", false, 0));
		...
		addLabel(label_8);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3CalibratePIDLLClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
	...
	void initProperties()
	{
		...
		addProperty("Port", "Ev3SensorPort", QString::fromUtf8("1"), QObject::tr("Port"), QObject::tr(""),
			false);
		addProperty("SetPoint", "int", QString::fromUtf8("45"), QObject::tr("Set point"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Calibrates the white threshold for each sensor in the array. Place the "
		                           "array over the white surface with all sensors on the white area."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		label_1->setPrefix(QObject::tr("Port:"));
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3CalibrateWhiteLLClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 1, 1.2, "XCoordinateCircle", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1, 1.8, "YCoordinateCircle", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 1, 2.4, "CircleRadius", false, 0));
		label_3->setBackground(Qt::white);
		label_3->setScalingX(false);
		label_3->setScalingY(false);
		label_3->setHard(false);
	...
	void initProperties()
	{
		addProperty("CircleRadius", "int", QString::fromUtf8("40"), QObject::tr("Radius"), QObject::tr(""),
			false);
		...
		addProperty("XCoordinateCircle", "int", QString::fromUtf8("85"), QObject::tr("X"), QObject::tr(""),
			false);
		addProperty("YCoordinateCircle", "int", QString::fromUtf8("70"), QObject::tr("Y"), QObject::tr(""),
			false);
	}
};
...
public:
	...
	{
		addProperty("Redraw", "bool", QString::fromUtf8("true"), QObject::tr("Redraw"), QObject::tr(""), false);
		addProperty("X1CoordinateLine", "int", QString::fromUtf8("20"), QObject::tr("X1"), QObject::tr(""),
			false);
		addProperty("X2CoordinateLine", "int", QString::fromUtf8("150"), QObject::tr("X2"), QObject::tr(""),
			false);
		addProperty("Y1CoordinateLine", "int", QString::fromUtf8("90"), QObject::tr("Y1"), QObject::tr(""),
			false);
		addProperty("Y2CoordinateLine", "int", QString::fromUtf8("20"), QObject::tr("Y2"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_5(
			new qReal::LabelProperties(5, 1, 3.6, "Filled", false, 0));
		label_5->setBackground(Qt::white);
		label_5->setScalingX(false);
		label_5->setScalingY(false);
		label_5->setHard(false);
	...
	void initProperties()
	{
		addProperty("Filled", "bool", QString::fromUtf8("false"), QObject::tr("Filled"), QObject::tr(""),
			false);
		addProperty("HeightRect", "int", QString::fromUtf8("30"), QObject::tr("Height"), QObject::tr(""),
			false);
		addProperty("Redraw", "bool", QString::fromUtf8("true"), QObject::tr("Redraw"), QObject::tr(""), false);
		addProperty("WidthRect", "int", QString::fromUtf8("40"), QObject::tr("Width"), QObject::tr(""), false);
		addProperty("XCoordinateRect", "int", QString::fromUtf8("75"), QObject::tr("X"), QObject::tr(""),
			false);
		addProperty("YCoordinateRect", "int", QString::fromUtf8("50"), QObject::tr("Y"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Enables motors on the given ports in reverse mode with the given power. "
		                           "Ports are specified with A, B or C letters divided by commas. The power is "
		                           "specified in percents with the number from -100 to 100, if negative number "
		                           "is specified then the motor is enabled in the usual mode."));
		QSharedPointer<qReal::LabelProperties> label_1(
		...
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3EnginesBackwardClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr(
			"Enables motors on the given ports with the given power. Ports are specified with A, B or C "
		        "letters divided by commas. The power is specified in percents with the number from -100 to "
		        "100, if negative number is specified then the motor is enabled in the reverse mode."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.5, -0.7, "Ports", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		label_2->setPrefix(QObject::tr("Power:"));
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3EnginesForwardClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
	...
	void initProperties()
	{
		addProperty("Mode", "BrakeEngineMode", QString::fromUtf8("brake"), QObject::tr("Mode"), QObject::tr(""),
			false);
		addProperty("Ports", "string", QObject::tr("A, B, C, D"), QObject::tr("Ports"), QObject::tr(""), false);
	}
};
...
public:
	...
	void initProperties()
	{
		addProperty("Color", "Ev3LedColor", QString::fromUtf8("red"), QObject::tr("Color"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr(
			"Plays on the robot a sound with the given frequency and duration. This block is similar to "
		        "the 'Beep' block wuth the only difference that here you can specify sound parameters."));
		QSharedPointer<qReal::LabelProperties> label_1(
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1.2, 1.2, "Volume", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 1.2, 1.8, "Duration", false, 0));
		label_3->setBackground(Qt::white);
		label_3->setScalingX(false);
		label_3->setScalingY(false);
		label_3->setHard(false);
		...
		addLabel(label_3);
		QSharedPointer<qReal::LabelProperties> label_4(
			new qReal::LabelProperties(4, 1.2, 2.4, "WaitForCompletion", false, 0));
		label_4->setBackground(Qt::white);
		label_4->setScalingX(false);
		label_4->setScalingY(false);
		label_4->setHard(false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Read the values from the Line Leader.  Amount of light or dark each sensor "
		                           "sees.  Typically between 0-20.  0=black, 100=white."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.9, 1.2, "Variable", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
	...
	void initProperties()
	{
		addProperty("Port", "Ev3SensorPort", QString::fromUtf8("1"), QObject::tr("Port"), QObject::tr(""),
			false);
		addProperty("Variable", "string", QObject::tr("a"), QObject::tr("Array Variable"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr(
			"Read the Weighted Average value from the sensor.  This value is calculated internally by the "
		        "sensor where each of the eight sensors is either triggered or not and multiplied by a factor "
		        "to help determine if the line is left, right or on center of the line (according to the set "
		        "point). EXPECTED VALUES: 0-80 (-1=ERROR)"));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.8, 1.2, "RVariable", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 0.8, 1.8, "GVariable", false, 0));
		label_3->setBackground(Qt::white);
		label_3->setScalingX(false);
		label_3->setScalingY(false);
		label_3->setHard(false);
		...
		addLabel(label_3);
		QSharedPointer<qReal::LabelProperties> label_4(
			new qReal::LabelProperties(4, 0.8, 2.4, "BVariable", false, 0));
		label_4->setBackground(Qt::white);
		label_4->setScalingX(false);
		label_4->setScalingY(false);
		label_4->setHard(false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Read the Steering value from the sensor.  This value is calculated "
		                           "internally and can directly be used to set turning values for the robot's "
		                           "motors. EXPECTED VALUES: -100 to 100 (-101=ERROR)"));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		label_2->setPrefix(QObject::tr("Variable:"));
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3ReadSteeringLLClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Sends mail (message) to another robot. If Receiver name left empty, "
		                           "message will be sent to all connected robots"));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.9, 1.2, "MsgType", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.9, 1.8, "Message", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 0.9, 2.4, "ReceiverName", false, 0));
		label_3->setBackground(Qt::white);
		label_3->setScalingX(false);
		label_3->setScalingY(false);
		label_3->setHard(false);
		...
		addLabel(label_3);
		QSharedPointer<qReal::LabelProperties> label_4(
			new qReal::LabelProperties(4, 0.9, 3, "ReceiverMailBoxName", false, 0));
		label_4->setBackground(Qt::white);
		label_4->setScalingX(false);
		label_4->setScalingY(false);
		label_4->setHard(false);
	...
	void initProperties()
	{
		...
		addProperty("MsgType", "Ev3MsgType", QString::fromUtf8("int"), QObject::tr("Message type"),
			QObject::tr(""), false);
		addProperty("ReceiverMailBoxName", "string", QObject::tr("EV3MailBox"), QObject::tr("Mailbox name"),
			QObject::tr(""), false);
		addProperty("ReceiverName", "string", QObject::tr(""), QObject::tr("Receiver name"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(
			QObject::tr("Starts compass calibration under program control. To calibrate, robot needs to "
		                    "spin >=540 clockwise and counterclockwise with minimum 20 seconds duration for "
		                    "each direction. Atfer robot rotation add Stop Compass Сalibration block."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		label_1->setPrefix(QObject::tr("Port:"));
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3StartCompassCalibrationClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Ends compass calibration process. Stores result of calibration into the "
		                           "given variable. Not zero means success."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.8, 1.2, "Variable", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		label_2->setPrefix(QObject::tr("Variable:"));
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3StopCompassCalibrationClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3WaitForButtonClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
	...
	void initProperties()
	{
		addProperty("Button", "Ev3Buttons", QString::fromUtf8("Up"), QObject::tr("Button"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(
			QObject::tr("Waits till the color sensor on the given port will recognize the given color."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.74, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.74, 1.2, "Color", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Waits till the value returned by the color sensor on the given port will "
		                           "be greater or less than the given in the 'Intensity' parameter value (the "
		                           "intensity is specified in percents, 0 to 100)."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1.1, 1.2, "Intensity", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_3);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3WaitForColorIntensityClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		label_3->setPrefix(QObject::tr("Sign:"));
		addLabel(label_3);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3WaitForEncoderClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
	...
	void initProperties()
	{
		addProperty("Port", "Ev3MotorPort", QString::fromUtf8("B"), QObject::tr("Port"), QObject::tr(""),
			false);
		addProperty("Sign", "DistanceSign", QString::fromUtf8("greater"), QObject::tr("Sign"), QObject::tr(""),
			false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1.1, 1.2, "Degrees", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		label_3->setPrefix(QObject::tr("Sign:"));
		addLabel(label_3);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3WaitForGyroscopeClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(
			QObject::tr("Stores a message from another robot (fom mailbox) into a given variable. When no "
		                    "incoming messages are present at the moment, a robot will wait for incoming "
		                    "message if 'Synchronized' property is true, and doing nothing otherwise."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.9, 1.2, "MsgType", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.9, 1.8, "MailBoxName", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 0.9, 2.4, "Variable", false, 0));
		label_3->setBackground(Qt::white);
		label_3->setScalingX(false);
		label_3->setScalingY(false);
		label_3->setHard(false);
		...
		addLabel(label_3);
		QSharedPointer<qReal::LabelProperties> label_4(
			new qReal::LabelProperties(4, 0.9, 3, "Synchronized", false, 0));
		label_4->setBackground(Qt::white);
		label_4->setScalingX(false);
		label_4->setScalingY(false);
		label_4->setHard(false);
		...
		addLabel(label_4);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3WaitForReceivingMailClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
	...
	void initProperties()
	{
		addProperty("MailBoxName", "string", QObject::tr("EV3MailBox"), QObject::tr("Mailbox name"),
			QObject::tr(""), false);
		addProperty("MsgType", "Ev3MsgType", QString::fromUtf8("int"), QObject::tr("Message type"),
			QObject::tr(""), false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Waits till the value returned by the ultrasonic or infrared range sensor "
		                           "on the given port will be greater or less than the given in the 'Distance' "
		                           "parameter value (the distance is specified in centimeters, 0 to 255)."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1, 1.2, "Distance", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		label_3->setPrefix(QObject::tr("Sign:"));
		addLabel(label_3);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3WaitForSonarDistanceClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Waits till the loudness obtained by the sound sensor on the given port "
		                           "will be greater or less than the given value."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1, 1.2, "Volume", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		label_1->setPrefix(QObject::tr("Port:"));
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/Ev3WaitForTouchSensorClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
