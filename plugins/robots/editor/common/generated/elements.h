...
#include <metaMetaModel/labelProperties.h>
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			qReal::LabelProperties label_1(1, 0.1, 0.2, "Comment", false, 0);
	...
	public:
			...
			: EdgeElementType(metamodel)
		{
			...
			qReal::LabelProperties label_1(1, 0, 0, "Guard", false, 0);
			label_1.setBackground(Qt::white);
			label_1.setScalingX(false);
			label_1.setScalingY(false);
			label_1.setHard(true);
...
;			initProperties();
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			qReal::LabelProperties label_1(1, 0.6, 1.2, "Variable", false, 0);
			label_1.setBackground(Qt::white);
			label_1.setScalingX(false);
			label_1.setScalingY(false);
			label_1.setHard(true);
			...
			addLabel(label_1);
			qReal::LabelProperties label_2(2, 0.6, 1.8, "Wait", false, 0);
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			qReal::LabelProperties label_1(1, 0.8, 1.2, "Condition", false, 0);
			label_1.setBackground(Qt::white);
			label_1.setScalingX(false);
			label_1.setScalingY(false);
			label_1.setHard(false);
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			qReal::LabelProperties label_1(1, 0.6, 1.2, "Thread", false, 0);
			label_1.setBackground(Qt::white);
			label_1.setScalingX(false);
			label_1.setScalingY(false);
			label_1.setHard(false);
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			qReal::LabelProperties label_1(1, 0.8, -0.7, "Iterations", false, 0);
			label_1.setBackground(Qt::white);
			label_1.setScalingX(false);
			label_1.setScalingY(false);
			label_1.setHard(true);
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			qReal::LabelProperties label_1(1, 0.54, -0.7, "Color", false, 0);
			label_1.setBackground(Qt::white);
			label_1.setScalingX(false);
			label_1.setScalingY(false);
			label_1.setHard(true);
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			qReal::LabelProperties label_1(1, 1, 1.2, "XCoordinateText", false, 0);
			label_1.setBackground(Qt::white);
			label_1.setScalingX(false);
			label_1.setScalingY(false);
			label_1.setHard(false);
			...
			addLabel(label_1);
			qReal::LabelProperties label_2(2, 1, 1.8, "YCoordinateText", false, 0);
			label_2.setBackground(Qt::white);
			label_2.setScalingX(false);
			label_2.setScalingY(false);
			...
			addLabel(label_2);
			qReal::LabelProperties label_3(3, 1, 2.4, "PrintText", false, 0);
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			label_1.setPrefix(QObject::tr("Variable:"));
			addLabel(label_1);
			qReal::LabelProperties label_2(2, 0.6, 1.8, "LowerBound", false, 0);
			label_2.setBackground(Qt::white);
			label_2.setScalingX(false);
			label_2.setScalingY(false);
			label_2.setHard(false);
			...
			addLabel(label_2);
			qReal::LabelProperties label_3(3, 0.6, 2.4, "UpperBound", false, 0);
			label_3.setBackground(Qt::white);
			label_3.setScalingX(false);
			label_3.setScalingY(false);
			label_3.setHard(false);
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			label_1.setPrefix(QObject::tr("Variable:"));
			addLabel(label_1);
			qReal::LabelProperties label_2(2, 0.6, 1.8, "Synchronized", false, 0);
			label_2.setBackground(Qt::white);
			label_2.setScalingX(false);
			label_2.setScalingY(false);
			label_2.setHard(false);
	...
	public:
			...
			: PatternType(metamodel)
		{
			...
			setDiagram("RobotsDiagram");
			setDescription(QObject::tr(""));
			setXml(QString::fromUtf8(" <group rootNode=\"diagram\" name=\"RobotsDiagramGroup\">\n  <groupNode yPosition=\"0\" xPosition=\"0\" name=\"diagram\" type=\"RobotsDiagramNode\"/>\n  <groupNode yPosition=\"300\" xPosition=\"50\" name=\"initialNode\" parent=\"diagram\" type=\"InitialNode\"/>\n </group>\n"));
		}
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			setDiagram("RobotsDiagram");
			setDescription(QObject::tr(""));
			qReal::LabelProperties label_1(1, 0.205882, 0.0588235, "name", false, 0);
			label_1.setBackground(Qt::white);
			label_1.setScalingX(false);
			label_1.setScalingY(false);
			label_1.setHard(false);
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			label_1.setPrefix(QObject::tr("Thread:"));
			addLabel(label_1);
			qReal::LabelProperties label_2(2, 0.6, 1.8, "Message", false, 0);
			label_2.setBackground(Qt::white);
			label_2.setScalingX(false);
			label_2.setScalingY(false);
			label_2.setHard(false);
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			qReal::LabelProperties label_1(1, -0.4, -0.7, "name", false, 0);
			label_1.setBackground(Qt::white);
			label_1.setScalingX(false);
			label_1.setScalingY(false);
			label_1.setHard(true);
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			qReal::LabelProperties label_1(1, 1, 1.2, "Expression", false, 0);
			label_1.setBackground(Qt::white);
			label_1.setScalingX(false);
			label_1.setScalingY(false);
			label_1.setHard(false);
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			qReal::LabelProperties label_1(1, 0.6, -0.7, "Delay", false, 0);
			label_1.setBackground(Qt::white);
			label_1.setScalingX(false);
			label_1.setScalingY(false);
			label_1.setHard(true);
	...
	public:
			...
			: NodeElementType(metamodel)
		{
			...
			label_1.setPrefix(QObject::tr("Variable:"));
			addLabel(label_1);
			qReal::LabelProperties label_2(2, 0.66, 1.8, "value", false, 0);
			label_2.setBackground(Qt::white);
			label_2.setScalingX(false);
			label_2.setScalingY(false);
			label_2.setHard(false);
