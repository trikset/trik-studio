...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("This block can hold text notes that are ignored by generators and "
		                           "interpreters. Use it for improving the diagram readability."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.1, 0.2, "Comment", false, 0));
		...
		initProperties();
		setMouseGesture("");
		addLinePort(qReal::LinePortInfo(QLineF(0, 0.05, 0, 0.95), false, false, false, false, 200, 100,
			"NonTyped"));
		addLinePort(qReal::LinePortInfo(QLineF(0.025, 0, 0.875, 0), false, false, false, false, 200, 100,
			"NonTyped"));
		addLinePort(qReal::LinePortInfo(QLineF(1, 0.25, 1, 0.95), false, false, false, false, 200, 100,
			"NonTyped"));
		addLinePort(qReal::LinePortInfo(QLineF(0.025, 1, 0.975, 1), false, false, false, false, 200, 100,
			"NonTyped"));
		addLinePort(
			qReal::LinePortInfo(QLineF(0.9, 0, 1, 0.2), false, false, false, false, 200, 100, "NonTyped"));
		addLinePort(
			qReal::LinePortInfo(QLineF(0, 0.1, 0, 0.9), false, false, false, false, 50, 50, "NonTyped"));
		addLinePort(
			qReal::LinePortInfo(QLineF(0.1, 0, 0.9, 0), false, false, false, false, 50, 50, "NonTyped"));
	...
	void initProperties()
	{
		addProperty("Comment", "string", QObject::tr("Enter some text here..."), QObject::tr("Comment"),
			QObject::tr(""), false);
	}
};
...
public:
		...
		: EdgeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr(
			"For creating a link between two elements A and B you can just hover a mouse above A, press "
		        "the right mouse button and (without releasing it) draw a line to the element B. Alternatively "
		        "you can just 'pull' a link from a small blue circle next to the element."));
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("The final node of the program. If the program consists of some parallel "
		                           "execution lines the reachment of this block terminates the corresponding "
		                           "execution line. This block can`t have outgoing links."));
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr(
			"Separates program execution into a number of threads that will be executed concurrently from "
		        "the programmers`s point of view. For example in such way signal from sensor and some time "
		        "interval can be waited synchroniously. This block must have at least two outgoing links. "
		        "'Guard' property of every link must contain unique thread identifiers, and one of those "
		        "identifiers must be the same as the identifier of a thread where fork is placed (it must be "
		        "'main' if it is the first fork in a program."));
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Evaluates a value of the given expression. Also new variables can be "
		                           "defined in this block. See the 'Expressions Syntax' chapter in help for "
		                           "more information about 'Function' block syntax."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.6, 1.2, "Body", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(
			QObject::tr("Assigns a given variable a value of pressed button. If no button is pressed at "
		                    "the moment and 'Wait' property is false when variable is set to -1."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.6, 1.2, "Variable", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
		...
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.6, 1.8, "Wait", false, 0));
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr(
			"Separates program execution in correspondece with the given condition. The 'Condition' "
		        "parameter value must be some boolean expression that will determine subsequent program "
		        "execution line. This block must have two outgoing links, at least one of them must have "
		        "'Guard' parameter set to 'true' or 'false'. The execution will be proceed trough the link "
		        "marked with the guard corresponding to 'Condition' parameter of the block."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, 1.2, "Condition", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
	...
	void initProperties()
	{
		addProperty("Condition", "string", QObject::tr("x > 0"), QObject::tr("Condition"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(
			QObject::tr("The entry point of the program execution. Each diagram should have only one such "
		                    "block, it must not have incomming links and it must have only one outgoing link. "
		                    "The interpretation process starts from exactly this block."));
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.66, 1.8, "default", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		...
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 0.66, 2.4, "prompt", false, 0));
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr(
			"Joins a number of threads into one. 'Guard' property of the single outgoing link must contain "
		        "an identifier of one of threads being joined. The specified thread would wait until the rest "
		        "of them finish execution, and then proceed in a normal way."));
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.6, 1.2, "Thread", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr(
			"This block executes a sequence of blocks for a given number of times. The number of "
		        "repetitions is specified by the 'Iterations' parameter. This block must have two outgoing "
		        "links. One of them must be marked with the 'body' guard (that means that the property 'Guard' "
		        "of the link must be set to 'body' value). Another outgoing link must be unmarked: the program "
		        "execution will be proceeded through this link when it will go through our 'Loop' block for "
		        "the given number of times."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Iterations", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
	...
	void initProperties()
	{
		addProperty("Iterations", "string", QObject::tr("10"), QObject::tr("Iterations"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Moves the marker of the 2D model robot down to the floor: the robot will "
		                           "draw its trace on the floor after that. If the marker of another color is "
		                           "already drawing at the moment it will be replaced."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.54, -0.7, "Color", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
	...
	void initProperties()
	{
		addProperty("Color", "BackgroundColor", QString::fromUtf8("blue"), QObject::tr("Color"),
			QObject::tr(""), false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Lifts the marker of the 2D model robot up: the robot stops drawing its "
		                           "trace on the floor after that."));
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(
			QObject::tr("This block executes a sequence of blocks while condition in 'Condition' is true. "
		                    "This block must have two outgoing links. One of them must be marked with the "
		                    "'body' guard (that means that the property 'Guard' of the link must be set to "
		                    "'body' value). Another outgoing link must be unmarked: the program execution will "
		                    "be proceeded through this link when condition becomes false."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Condition", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
		...
		label_1->setPrefix(QObject::tr("Condition:"));
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/PreconditionalLoopClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(
			QObject::tr("Prints a given line in the specified coordinates on the robot`s screen. The value "
		                    "of 'Text' property is interpreted as a plain text unless 'Evaluate' property is "
		                    "set to true, then it will be interpreted as an expression (that may be useful for "
		                    "example when debugging variables values)."));
		QSharedPointer<qReal::LabelProperties> label_1(
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.6, 1.8, "LowerBound", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 0.6, 2.4, "UpperBound", false, 0));
		label_3->setBackground(Qt::white);
		label_3->setScalingX(false);
		label_3->setScalingY(false);
		label_3->setHard(false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.6, 1.8, "Synchronized", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/ReceiveMessageThreadsClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: PatternType(metamodel)
	{
		...
		setXml(QString::fromUtf8(" <group rootNode=\"diagram\" name=\"RobotsDiagramGroup\">\n  <groupNode "
		                         "type=\"RobotsDiagramNode\" name=\"diagram\" xPosition=\"0\" "
		                         "yPosition=\"0\"/>\n  <groupNode type=\"InitialNode\" parent=\"diagram\" "
		                         "name=\"initialNode\" xPosition=\"50\" yPosition=\"300\"/>\n </group>\n"));
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDescription(QObject::tr(""));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.205882, 0.0588235, "name", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		label_1->setPlainTextMode(false);
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/RobotsDiagramNodeClass.sdf")
				.documentElement());
	...
	void initProperties()
	{
		addProperty("devicesConfiguration", "string", QObject::tr(""), QObject::tr("Devices configuration"),
			QObject::tr(""), false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.6, 1.8, "Message", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/SendMessageThreadsClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
		...
		: NodeElementType(metamodel)
	{
		...
		setDescription(QObject::tr(
			"Subprogram call. Subprograms are used for splitting repetitive program parts into a separate "
		        "diagram and then calling it from main diagram or other subprograms. When this block is added "
		        "into a diagram it will be suggested to enter subprogram name. The double click on subprogram "
		        "call block may open the corresponding subprogram diagram. Moreover user palette will appear "
		        "containing existing subrpograms, they can be dragged into a diagram like the usual blocks."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, -0.4, -0.7, "name", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		label_1->setPlainTextMode(false);
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/SubprogramDiagramClass.sdf")
				.documentElement());
		setSize(QSizeF(204, 204));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: PatternType(metamodel)
	{
		...
		setXml(QString::fromUtf8(" <group rootNode=\"diagram\" name=\"SubprogramDiagramGroup\">\n  <groupNode "
		                         "type=\"SubprogramDiagram\" name=\"diagram\" xPosition=\"0\" "
		                         "yPosition=\"0\"/>\n  <groupNode type=\"InitialNode\" parent=\"diagram\" "
		                         "name=\"initialNode\" xPosition=\"50\" yPosition=\"300\"/>\n </group>\n"));
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(
			QObject::tr("Selects the program execution branch in correspondence with some expression "
		                    "value. The value of the expression written in 'Expression' property is compared "
		                    "to the values on the outgoing links. If equal value is found then execution will "
		                    "be proceeded by that branch. Else branch without a marker will be selected."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 1, 1.2, "Expression", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
	...
	void initProperties()
	{
		addProperty("Expression", "string", QObject::tr("x"), QObject::tr("Expression"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.6, -0.7, "Delay", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.66, 1.8, "value", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
