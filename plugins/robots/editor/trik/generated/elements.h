...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setMouseGesture("");
		addLinePort(
			qReal::LinePortInfo(QLineF(0, 0.1, 0, 0.9), false, false, false, false, 50, 50, "NonTyped"));
		addLinePort(
			qReal::LinePortInfo(QLineF(0.1, 0, 0.9, 0), false, false, false, false, 50, 50, "NonTyped"));
		addLinePort(
			qReal::LinePortInfo(QLineF(1, 0.1, 1, 0.9), false, false, false, false, 50, 50, "NonTyped"));
		addLinePort(
			qReal::LinePortInfo(QLineF(0.1, 1, 0.9, 1), false, false, false, false, 50, 50, "NonTyped"));
		setResizable(true);
		setContainer(false);
	...
	void initProperties()
	{
		addProperty("Port", "TrikV6AnalogSensorPort", QString::fromUtf8("A1"), QObject::tr("Port"),
			QObject::tr(""), false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Manages angular servomotor. Sets up rotation angle on the given port in "
		                           "degrees. Values from 0 to 90 are correspond to a clockwise rotation and "
		                           "values from -90 to 0 correspond to counterclockwise rotation."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.5, -0.7, "Ports", false, 0));
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.7, 1.2, "Power", false, 0));
		...
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikAngularServoClass.sdf")
				.documentElement());
	...
	void initProperties()
	{
		...
		addProperty("Power", "string", QObject::tr("0"), QObject::tr("Angle (degrees)"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikCalibrateGyroscopeClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Initializes videocamera line or object detector with the color of the "
		                           "object in the middle of the camera`s sight."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Mode", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, -0.5, 1.2, QObject::tr("Detect by Videocamera"), 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, -0.3, 1.2, QObject::tr("Line Detector into Variable"), 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.8, 1.8, "Variable", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikDetectorToVariableClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
	...
	void initProperties()
	{
		addProperty("Port", "TrikV6DigitalSensorPort", QString::fromUtf8("D1"), QObject::tr("Port"),
			QObject::tr(""), false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Draws the arc defined by the rectangle beginning at (x, y) with the "
		                           "specified width and height, and the given startAngle and spanAngle."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 1, 1.2, "XCoordinateArc", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1, 1.8, "YCoordinateArc", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 1, 2.4, "WidthArc", false, 0));
		...
		addLabel(label_3);
		QSharedPointer<qReal::LabelProperties> label_4(
			new qReal::LabelProperties(4, 1, 3, "HeightArc", false, 0));
		...
		addLabel(label_4);
		QSharedPointer<qReal::LabelProperties> label_5(
			new qReal::LabelProperties(5, 1, 3.6, "StartAngle", false, 0));
		...
		addLabel(label_5);
		QSharedPointer<qReal::LabelProperties> label_6(
			new qReal::LabelProperties(6, 1, 4.2, "SpanAngle", false, 0));
	...
	void initProperties()
	{
		...
		addProperty("SpanAngle", "int", QString::fromUtf8("20"), QObject::tr("SpanAngle"), QObject::tr(""),
			false);
		addProperty("StartAngle", "int", QString::fromUtf8("20"), QObject::tr("StartAngle"), QObject::tr(""),
			false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Draws the ellipse defined by the rectangle beginning at (x, y) with the "
		                           "given width and height."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 1, 1.2, "XCoordinateEllipse", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1, 1.8, "YCoordinateEllipse", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 1, 2.4, "WidthEllipse", false, 0));
		label_3->setBackground(Qt::white);
		label_3->setScalingX(false);
		label_3->setScalingY(false);
		label_3->setHard(false);
		...
		addLabel(label_3);
		QSharedPointer<qReal::LabelProperties> label_4(
			new qReal::LabelProperties(4, 1, 3, "HeightEllipse", false, 0));
		label_4->setBackground(Qt::white);
		label_4->setScalingX(false);
		label_4->setScalingY(false);
		label_4->setHard(false);
	...
	void initProperties()
	{
		addProperty("Filled", "bool", QString::fromUtf8("false"), QObject::tr("Filled"), QObject::tr(""),
			false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.72, 1.2, "X1CoordinateLine", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.72, 1.8, "Y1CoordinateLine", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 0.72, 2.4, "X2CoordinateLine", false, 0));
		label_3->setBackground(Qt::white);
		label_3->setScalingX(false);
		label_3->setScalingY(false);
		label_3->setHard(false);
		...
		addLabel(label_3);
		QSharedPointer<qReal::LabelProperties> label_4(
			new qReal::LabelProperties(4, 0.72, 3, "Y2CoordinateLine", false, 0));
		label_4->setBackground(Qt::white);
		label_4->setScalingX(false);
		label_4->setScalingY(false);
		label_4->setHard(false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.72, 1.2, "XCoordinatePix", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.72, 1.8, "YCoordinatePix", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(
			QObject::tr("Draws a rectangle on the robot screen. The parameters specify the coordinates of "
		                    "top-left corner, the width and the height of the rectangle."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 1, 1.2, "XCoordinateRect", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1, 1.8, "YCoordinateRect", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 1, 2.4, "WidthRect", false, 0));
		label_3->setBackground(Qt::white);
		label_3->setScalingX(false);
		label_3->setScalingY(false);
		label_3->setHard(false);
		...
		addLabel(label_3);
		QSharedPointer<qReal::LabelProperties> label_4(
			new qReal::LabelProperties(4, 1, 3, "HeightRect", false, 0));
		label_4->setBackground(Qt::white);
		label_4->setScalingX(false);
		label_4->setScalingY(false);
		label_4->setHard(false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Enables line or object or color detector by videocamera and draws "
		                           "videostream on the robot`s screen."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Mode", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, -0.5, 1.2, QObject::tr("Initialize Videocamera"), 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
	...
	void initProperties()
	{
		addProperty("DrawStream", "Bool", QString::fromUtf8("true"), QObject::tr("Draw stream"),
			QObject::tr(""), false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Enables video stream on robot. Video then can be watched on TRIK gamepad "
		                           "or in browser using URL http://ROBOT.IP.ADDRESS:8080/?action=stream"));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, -0.5, 1.2, QObject::tr("Enable Video Streaming"), 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		label_1->setPlainTextMode(false);
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikInitVideoStreamingClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
class TrikJoinNetwork : public qReal::NodeElementType
{
public:
	explicit TrikJoinNetwork(qReal::Metamodel &metamodel)
		: NodeElementType(metamodel)
	{
		setName("TrikJoinNetwork");
		setFriendlyName(QObject::tr("Join Network"));
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Sets the hull number and connects with a peer by a (host)name or an "
		                           "IP-address. Target IP-port can be changed too if required."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.9, 1.2, "Address", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.9, 1.8, "HullNumber", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikJoinNetworkClass.sdf").documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
		addLinePort(
	...
	void initProperties()
	{
		addProperty("Address", "string", QObject::tr("192.168.77.1"), QObject::tr("Address"), QObject::tr(""),
			false);
		addProperty("HullNumber", "int", QString::fromUtf8("1"), QObject::tr("Hull Number"), QObject::tr(""),
			false);
		addProperty("IPPort", "int", QString::fromUtf8("8889"), QObject::tr("Port"), QObject::tr(""), false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.7, -0.7, "Color", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
	...
	void initProperties()
	{
		addProperty("Color", "TrikLedColor", QString::fromUtf8("red"), QObject::tr("Color"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(
			QObject::tr("Plays on the robot a sound file (.wav or .mp3) previously uploaded to it."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 1, -0.7, "FileName", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
	...
	void initProperties()
	{
		addProperty("FileName", "string", QObject::tr("media/beep.wav"), QObject::tr("File Name"),
			QObject::tr(""), false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 1, -0.7, "Frequency", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1, 1.2, "Duration", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
	...
	void initProperties()
	{
		...
		addProperty("Frequency", "string", QObject::tr("1000"), QObject::tr("Frequency"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(
			QObject::tr("Prints a given line in the specified coordinates and font size on the robot`s "
		                    "screen. The value of 'Text' property is interpreted as a plain text unless "
		                    "'Evaluate' property is set to true, then it will be interpreted as an expression "
		                    "(that may be useful for example when debugging variables values)."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 1, 1.2, "XCoordinateText", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1, 1.8, "YCoordinateText", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 1, 2.4, "PrintText", false, 0));
		label_3->setBackground(Qt::white);
		label_3->setScalingX(false);
		label_3->setScalingY(false);
		label_3->setHard(false);
		...
		addLabel(label_3);
		QSharedPointer<qReal::LabelProperties> label_4(
			new qReal::LabelProperties(4, 1, 3, "FontSize", false, 0));
		label_4->setBackground(Qt::white);
		label_4->setScalingX(false);
		label_4->setScalingY(false);
		label_4->setHard(false);
	...
	void initProperties()
	{
		addProperty("Evaluate", "bool", QString::fromUtf8("false"), QObject::tr("Evaluate"), QObject::tr(""),
			false);
		addProperty("FontSize", "string", QObject::tr("20"), QObject::tr("Font size"), QObject::tr(""), false);
		addProperty("PrintText", "string", QObject::tr("Enter some text here"), QObject::tr("Text"),
			QObject::tr(""), false);
		addProperty("Redraw", "bool", QString::fromUtf8("true"), QObject::tr("Redraw"), QObject::tr(""), false);
...
class TrikReadLidar : public qReal::NodeElementType
{
public:
	explicit TrikReadLidar(qReal::Metamodel &metamodel)
		: NodeElementType(metamodel)
	{
		setName("TrikReadLidar");
		setFriendlyName(QObject::tr("Read Lidar To Variable"));
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Assigns a value from lidar to a given variable."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.66, 1.2, "variable", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		...
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikReadLidarClass.sdf").documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
		addLinePort(
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Removes a file. File path may be absolute or relative to a directory "
		                           "containing TRIK Studio executable."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.66, 1.2, "File", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Synthesizes the given phrase and plays it on the robot. If 'Evaluate' "
		                           "property is set to true then the value of 'Text' property is interpreted "
		                           "as a formula, otherwise it is interpreted as plain string."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.7, -0.7, "Text", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.9, 1.2, "Message", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
	...
	void initProperties()
	{
		addProperty("HullNumber", "string", QObject::tr(""), QObject::tr("Hull Number"), QObject::tr(""),
			false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		label_1->setPrefix(QObject::tr("Color:"));
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikSetBackgroundClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
	...
	void initProperties()
	{
		addProperty("Color", "BackgroundColor", QString::fromUtf8("white"), QObject::tr("Color"),
			QObject::tr(""), false);
		addProperty("Redraw", "bool", QString::fromUtf8("true"), QObject::tr("Redraw"), QObject::tr(""), false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.5, -0.7, "Color", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
		...
		label_1->setPrefix(QObject::tr("Color:"));
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikSetPainterColorClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
	...
	void initProperties()
	{
		addProperty("Color", "BackgroundColor", QString::fromUtf8("black"), QObject::tr("Color"),
			QObject::tr(""), false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 1, -0.7, "Width", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
		...
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikSetPainterWidthClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, -0.5, 1.2, QObject::tr("Stop Videocamera"), 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, -0.5, 1.2, QObject::tr("Disable Video Streaming"), 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		label_1->setPlainTextMode(false);
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikStopVideoStreamingClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Invokes bash script-style command on the robot. If 'Evaluate' property is "
		                           "set to true then the value of 'Command' property is interpreted as a "
		                           "formula, otherwise it is interpreted as plain string."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, 1.2, "Command", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
	...
	void initProperties()
	{
		...
		addProperty("Command", "string", QObject::tr("echo 123"), QObject::tr("Command"), QObject::tr(""),
			false);
		addProperty("Evaluate", "bool", QString::fromUtf8("false"), QObject::tr("Evaluate"), QObject::tr(""),
			false);
	}
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		label_2->setSuffix(QObject::tr("°"));
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikV62AngularServoClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Ports", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
		...
		label_1->setPrefix(QObject::tr("Ports:"));
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikV62ClearEncoderClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
	...
	void initProperties()
	{
		addProperty("Ports", "string", QObject::tr("E1, E2, E3, E4"), QObject::tr("Ports"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Waits till the tacho limit of the motor on the given port will reach the "
		                           "value of the 'Tacho Limit' parameter."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.8, 1.2, "TachoLimit", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 0.8, 1.8, "Sign", false, 0));
		label_3->setBackground(Qt::white);
		label_3->setScalingX(false);
		label_3->setScalingY(false);
		label_3->setHard(false);
		...
		addLabel(label_3);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikV62WaitForEncoderClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
	...
	void initProperties()
	{
		addProperty("Port", "TrikV62EncoderPort", QString::fromUtf8("E3"), QObject::tr("Port"), QObject::tr(""),
			false);
		addProperty("Sign", "DistanceSign", QString::fromUtf8("greater"), QObject::tr("Sign"), QObject::tr(""),
			false);
		addProperty("TachoLimit", "string", QObject::tr(""), QObject::tr("Tacho Limit"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		label_1->setPrefix(QObject::tr("Ports:"));
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikV6ClearEncoderClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("112, 176 : 78, 142 :  | 112, 176 : 148, 140 :  | 112, 33 : 11"
	...
	void initProperties()
	{
		addProperty("Ports", "string", QObject::tr("B1, B2, B3, B4"), QObject::tr("Ports"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr(
			"Enables motors on the given ports in reverse mode with the given power. Ports are specified "
		        "in accordance with TRIK controller notations (for example M1, E2) and divided by commas. The "
		        "power is specified in percents with the number from -100 to 100, if negative number is "
		        "specified then the motor is enabled in the usual mode."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.5, -0.7, "Ports", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		label_2->setSuffix(QObject::tr("%"));
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikV6EnginesBackwardClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(
			QObject::tr("Enables motors on the given ports with the given power. Ports are specified in "
		                    "accordance with TRIK controller notations (for example M1, E2) and divided by "
		                    "commas. The power is specified in percents with the number from -100 to 100, if "
		                    "negative number is specified then the motor is enabled in the reverse mode."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.5, -0.7, "Ports", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		label_2->setSuffix(QObject::tr("%"));
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikV6EnginesForwardClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		label_1->setPrefix(QObject::tr("Ports:"));
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikV6EnginesStopClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
	...
	void initProperties()
	{
		addProperty("Mode", "BrakeEngineMode", QString::fromUtf8("float"), QObject::tr("Mode"), QObject::tr(""),
			false);
		addProperty("Ports", "string", QObject::tr("M1, M2, M3, M4"), QObject::tr("Ports"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDescription(QObject::tr(""));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 1, 1.2, "Acceleration", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(new qReal::LabelProperties(2, 1, 1.8, "Sign", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 1, 2.4, "AccelerationAxis", false, 0));
		label_3->setBackground(Qt::white);
		label_3->setScalingX(false);
		label_3->setScalingY(false);
		label_3->setHard(false);
		...
		addLabel(label_3);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitForAccelerometerClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
	...
	void initProperties()
	{
		addProperty("Acceleration", "string", QObject::tr("0"), QObject::tr("Acceleration"), QObject::tr(""),
			false);
		addProperty("AccelerationAxis", "Accelerations", QString::fromUtf8("xAxis"),
			QObject::tr("Acceleration Axis"), QObject::tr(""), false);
		addProperty("Sign", "DistanceSign", QString::fromUtf8("greater"), QObject::tr("Sign"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, 1.2, "Button", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		...
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitForButtonClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
	...
	void initProperties()
	{
		addProperty("Button", "TrikButtons", QString::fromUtf8("Up"), QObject::tr("Button"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		label_3->setPrefix(QObject::tr("Sign:"));
		addLabel(label_3);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitForEncoderClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("203, 211 : 168, 176 :  | 203, 211 : 240, 174 :  | 12, 48 : 50"
	...
	void initProperties()
	{
		addProperty("Port", "TrikV6EncoderPort", QString::fromUtf8("B3"), QObject::tr("Port"), QObject::tr(""),
			false);
		addProperty("Sign", "DistanceSign", QString::fromUtf8("greater"), QObject::tr("Sign"), QObject::tr(""),
			false);
		addProperty("TachoLimit", "string", QObject::tr(""), QObject::tr("Tacho Limit"), QObject::tr(""),
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Waits till the value returned by the gyroscope on the given port will be "
		                           "greater or less than the given in the 'Degrees' parameter value."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 1.1, 1.2, "Degrees", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1.1, 1.8, "Sign", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		label_2->setPrefix(QObject::tr("Sign:"));
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitForGyroscopeClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(
			QObject::tr("Waits till the value returned by the infrared sensor on the given port will be "
		                    "greater or less than the given in the 'Distance' parameter value. By default on "
		                    "ports A1 and A2 the distance is specified in centimeters (from 0 to 100). It is "
		                    "not recommended to plug IR sensor into other ports because its raw value will be "
		                    "processed by software on robot with expectation of another sensor type."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1.1, 1.2, "Distance", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		QSharedPointer<qReal::LabelProperties> label_3(
			new qReal::LabelProperties(3, 1.1, 1.8, "Sign", false, 0));
		label_3->setBackground(Qt::white);
		label_3->setScalingX(false);
		label_3->setScalingY(false);
		label_3->setHard(false);
		...
		label_3->setPrefix(QObject::tr("Sign:"));
		addLabel(label_3);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitForIRDistanceClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(
			QObject::tr("Waits till the value returned by the light sensor on the given port will be "
		                    "greater or less than the given in the 'Percents' parameter value (0 to 100)."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.9, 1.2, "Percents", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		label_3->setPrefix(QObject::tr("Sign:"));
		addLabel(label_3);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitForLightClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr(
			"Stores a message from another robot into a given variable. When no incoming messages are "
		        "present at the moment, a robot will wait for incoming message if 'Synchronized' property is "
		        "true, and empty string will be assigned to a variable otherwise."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 1, 1.2, "Variable", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1, 1.8, "Synchronized", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitForMessageClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
	...
	void initProperties()
	{
		addProperty("Synchronized", "bool", QString::fromUtf8("true"), QObject::tr("Synchronized"),
			QObject::tr(""), false);
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, QObject::tr("F1"), 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
		...
		label_1->setPrefix(QObject::tr("Port:"));
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitForMotionClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Waits till the value returned by the ultrasonic sensor on the given port "
		                           "will be greater or less than the given in the 'Distance' parameter value "
		                           "(the distance is specified in centimeters, from 0 to 300)."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		label_3->setPrefix(QObject::tr("Sign:"));
		addLabel(label_3);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitForSonarDistanceClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Waits till the touch sensor is pressed. The only parameter is a sensor`s "
		                           "port number (1, 2, 3 or 4)."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		label_1->setPrefix(QObject::tr("Port:"));
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitForTouchSensorClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Waits for Android gamepad 'magic button' press. Buttons are identified by "
		                           "numbers from 1 to 5 (from left to right)"));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, -0.7, 1.2, QObject::tr("Wait gamepad button"), 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1, -0.7, "Button", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		...
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitGamepadButtonClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, -1.4, -0.7, QObject::tr("Wait for Gamepad Connect"), 0));
		...
		label_1->setPlainTextMode(false);
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitGamepadConnectClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, -1.4, -0.7, QObject::tr("Wait for Gamepad Disconnect"), 0));
		label_1->setBackground(Qt::transparent);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
		label_1->setPlainTextMode(false);
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitGamepadDisconnectClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr(
			"Waits till the value returned by gamepad wheel be greater or less than the given in the "
		        "'Angle' parameter value. Angle is measured from -100 (max left) to 100 (max right)."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, -1.4, -0.7, QObject::tr("Wait for Gamepad Wheel"), 0));
		label_1->setBackground(Qt::transparent);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(true);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 1.1, 1.2, "Angle", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
		...
		label_3->setPrefix(QObject::tr("Sign:"));
		addLabel(label_3);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitGamepadWheelClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, -0.4, 1.2, QObject::tr("Wait pad press"), 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		label_1->setScalingY(false);
		label_1->setHard(false);
		label_1->setPlainTextMode(false);
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(new qReal::LabelProperties(2, 1, -0.7, "Pad", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(true);
		...
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/TrikWaitPadPressClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDiagram("RobotsDiagram");
		setDescription(QObject::tr("Writes a given message to a file. File path may be absolute or relative to "
		                           "a directory containing TRIK Studio executable."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.66, 1.2, "File", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		addLabel(label_1);
		QSharedPointer<qReal::LabelProperties> label_2(
			new qReal::LabelProperties(2, 0.66, 1.8, "Text", false, 0));
		label_2->setBackground(Qt::white);
		label_2->setScalingX(false);
		label_2->setScalingY(false);
		label_2->setHard(false);
