...
public:
	...
	void initProperties()
	{
		addProperty("CircleRadius", "int", QString::fromUtf8("5"), QObject::tr("Radius"), QObject::tr(""),
			false);
		addProperty("Redraw", "bool", QString::fromUtf8("true"), QObject::tr("Redraw"), QObject::tr(""), false);
		addProperty("XCoordinateCircle", "int", QString::fromUtf8("0"), QObject::tr("X"), QObject::tr(""),
			false);
		addProperty("YCoordinateCircle", "int", QString::fromUtf8("0"), QObject::tr("Y"), QObject::tr(""),
			false);
	}
};
...
public:
	...
	{
		addProperty("Redraw", "bool", QString::fromUtf8("true"), QObject::tr("Redraw"), QObject::tr(""), false);
		addProperty("X1CoordinateLine", "int", QString::fromUtf8("0"), QObject::tr("X1"), QObject::tr(""),
			false);
		addProperty("X2CoordinateLine", "int", QString::fromUtf8("10"), QObject::tr("X2"), QObject::tr(""),
			false);
		addProperty("Y1CoordinateLine", "int", QString::fromUtf8("0"), QObject::tr("Y1"), QObject::tr(""),
			false);
		addProperty("Y2CoordinateLine", "int", QString::fromUtf8("10"), QObject::tr("Y2"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/NxtEnginesBackwardClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		label_2->setSuffix(QObject::tr("%"));
		addLabel(label_2);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/NxtEnginesForwardClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
	...
	void initProperties()
	{
		addProperty("Port", "NxtSensorPort", QString::fromUtf8("1"), QObject::tr("Port"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/NxtWaitForButtonClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
		setMouseGesture("");
	...
	void initProperties()
	{
		addProperty("Button", "NxtButtons", QString::fromUtf8("Enter"), QObject::tr("Button"), QObject::tr(""),
			false);
	}
};
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		addLabel(label_3);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/NxtWaitForColorIntensityClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		label_3->setPrefix(QObject::tr("Sign:"));
		addLabel(label_3);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/NxtWaitForEncoderClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		setDescription(QObject::tr("Waits till the value returned by the ultrasonic sensor on the given port "
		                           ...
		                           "(the distance is specified in centimeters, 0 to 255)."));
		QSharedPointer<qReal::LabelProperties> label_1(
			new qReal::LabelProperties(1, 0.8, -0.7, "Port", false, 0));
		label_1->setBackground(Qt::white);
		label_1->setScalingX(false);
		...
		label_3->setPrefix(QObject::tr("Sign:"));
		addLabel(label_3);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/NxtWaitForSonarDistanceClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
...
public:
		...
		: NodeElementType(metamodel)
	{
		...
		label_1->setPrefix(QObject::tr("Port:"));
		addLabel(label_1);
		loadSdf(utils::xmlUtils::loadDocument(":/generated/shapes/NxtWaitForTouchSensorClass.sdf")
				.documentElement());
		setSize(QSizeF(50, 50));
		initProperties();
