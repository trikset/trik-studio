...
void NxtMetamodelPlugin::initMultigraph()
{
	...
	mMetamodel->produceEdge(mMetamodel->elementType("RobotsDiagram", "NxtEnginesBackward"),
		mMetamodel->elementType("RobotsDiagram", "NxtEngineMovementCommand"),
		qReal::ElementType::generalizationLinkType);
	mMetamodel->produceEdge(mMetamodel->elementType("RobotsDiagram", "NxtEnginesForward"),
		mMetamodel->elementType("RobotsDiagram", "NxtEngineMovementCommand"),
		qReal::ElementType::generalizationLinkType);
	mMetamodel->produceEdge(mMetamodel->elementType("RobotsDiagram", "NxtEnginesStop"),
		mMetamodel->elementType("RobotsDiagram", "EngineCommand"), qReal::ElementType::generalizationLinkType);
	mMetamodel->produceEdge(mMetamodel->elementType("RobotsDiagram", "NxtWaitForColor"),
		mMetamodel->elementType("RobotsDiagram", "NxtSensorBlock"), qReal::ElementType::generalizationLinkType);
	mMetamodel->produceEdge(mMetamodel->elementType("RobotsDiagram", "NxtWaitForColorIntensity"),
		mMetamodel->elementType("RobotsDiagram", "NxtSensorBlock"), qReal::ElementType::generalizationLinkType);
	mMetamodel->produceEdge(mMetamodel->elementType("RobotsDiagram", "NxtWaitForLight"),
		mMetamodel->elementType("RobotsDiagram", "NxtSensorBlock"), qReal::ElementType::generalizationLinkType);
	mMetamodel->produceEdge(mMetamodel->elementType("RobotsDiagram", "NxtWaitForSonarDistance"),
		mMetamodel->elementType("RobotsDiagram", "NxtSensorBlock"), qReal::ElementType::generalizationLinkType);
	mMetamodel->produceEdge(mMetamodel->elementType("RobotsDiagram", "NxtWaitForSound"),
		mMetamodel->elementType("RobotsDiagram", "NxtSensorBlock"), qReal::ElementType::generalizationLinkType);
	mMetamodel->produceEdge(mMetamodel->elementType("RobotsDiagram", "NxtWaitForTouchSensor"),
		mMetamodel->elementType("RobotsDiagram", "NxtSensorBlock"), qReal::ElementType::generalizationLinkType);
}
...
void NxtMetamodelPlugin::initPaletteGroupsMap()
{
	...
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Actions"),
		QString::fromUtf8("NxtBeep"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Actions"),
		QString::fromUtf8("NxtPlayTone"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Actions"),
		QString::fromUtf8("NxtEnginesForward"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Actions"),
		QString::fromUtf8("NxtEnginesBackward"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Actions"),
		QString::fromUtf8("NxtEnginesStop"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Actions"),
		QString::fromUtf8("NxtClearEncoder"));
	...
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Wait"),
		QString::fromUtf8("NxtWaitForTouchSensor"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Wait"),
		QString::fromUtf8("NxtWaitForSonarDistance"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Wait"),
		QString::fromUtf8("NxtWaitForColor"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Wait"),
		QString::fromUtf8("NxtWaitForEncoder"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Wait"),
		QString::fromUtf8("NxtWaitForColorIntensity"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Wait"),
		QString::fromUtf8("NxtWaitForLight"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Wait"),
		QString::fromUtf8("NxtWaitForSound"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Wait"),
		QString::fromUtf8("NxtWaitForButton"));
	...
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Drawing"),
		QString::fromUtf8("NxtDrawRect"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Drawing"),
		QString::fromUtf8("NxtDrawPixel"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Drawing"),
		QString::fromUtf8("NxtDrawLine"));
	mMetamodel->addElementToDiagramPaletteGroup("RobotsDiagram", QObject::tr("Drawing"),
		QString::fromUtf8("NxtDrawCircle"));
}
...
void NxtMetamodelPlugin::initEnums()
{
	...
	mMetamodel->addEnum("NxtButtons",
		{qMakePair(QString("Enter"), tr("Enter")), qMakePair(QString("Escape"), tr("Escape")),
			qMakePair(QString("Left"), tr("Left")), qMakePair(QString("Right"), tr("Right"))});
	mMetamodel->setEnumEditable("NxtButtons", false);
	mMetamodel->addEnum("NxtSensorPort",
