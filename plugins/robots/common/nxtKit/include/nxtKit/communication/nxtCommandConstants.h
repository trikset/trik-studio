...
enum OutputPortEnum { port1, port2, port3, all = 0xFF };
}

namespace motorMode {
enum MotorModeEnum { MOTORON = 0x01, BRAKE = 0x02, REGULATED = 0x04 };
}
...
enum InputPortEnum { port1, port2, port3, port4 };
}
...
namespace sonarMode {
enum SonarModeEnum { OFF, SINGLE_SHOT, CONTINUOUS_MEASUREMENT, EVENT_CAPTURE, REQUEST_WARM_RESET };
}
...
enum SonarReadingModeEnum { METRIC = 1, INCH = 2 };
}
