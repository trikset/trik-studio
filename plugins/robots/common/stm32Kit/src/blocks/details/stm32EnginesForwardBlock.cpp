...
#include "stm32EnginesForwardBlock.h"
...
Stm32EnginesForwardBlock::Stm32EnginesForwardBlock(kitBase::robotModel::RobotModelInterface &robotModel)
	: kitBase::blocksBase::common::EngineCommandBlock(robotModel)
{
}

void Stm32EnginesForwardBlock::run()
{
