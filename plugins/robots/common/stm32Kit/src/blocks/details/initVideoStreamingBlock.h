...
class InitVideoStreamingBlock : public kitBase::blocksBase::common::DeviceBlock<stm32::robotModel::parts::Stm32Shell>
{
public:
	InitVideoStreamingBlock(kitBase::robotModel::RobotModelInterface &robotModel);

protected:
	virtual void doJob(robotModel::parts::Stm32Shell &shell);
};
