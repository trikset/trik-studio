...
void WaitGamepadButtonBlock::run()
{
	...
	mButton = RobotModelUtils::findDevice<robotModel::parts::Stm32GamepadButton>(mRobotModel, portName);
	...
	connect(mButton, &robotModel::parts::Stm32GamepadButton::newData, this, &WaitGamepadButtonBlock::responseSlot);
...
{
	return DeviceInfo::create<robotModel::parts::Stm32GamepadButton>();
}
