...
InitVideoStreamingBlock::InitVideoStreamingBlock(kitBase::robotModel::RobotModelInterface &robotModel)
	: kitBase::blocksBase::common::DeviceBlock<stm32::robotModel::parts::Stm32Shell>(robotModel)
{
}

void InitVideoStreamingBlock::doJob(stm32::robotModel::parts::Stm32Shell &shell)
{
