...
qReal::interpretation::Block *Stm32BlocksFactoryBase::produceBlock(const qReal::Id &element)
{
	if (elementMetatypeIs(element, "Stm32V6EnginesBackward")) {
...
qReal::IdList Stm32BlocksFactoryBase::providedBlocks() const
{
	qReal::IdList result;
...
qReal::IdList Stm32BlocksFactoryBase::blocksToDisable() const
{
	qReal::IdList result;
