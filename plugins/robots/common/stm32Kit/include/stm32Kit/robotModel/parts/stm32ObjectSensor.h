...
/// Device representing STM32 camera object detector.
class Stm32ObjectSensor : public kitBase::robotModel::robotParts::VectorSensor
{
	Q_OBJECT
	Q_CLASSINFO("name", "stm32ObjectSensor")
	Q_CLASSINFO("friendlyName", tr("Object Sensor"))

public:
	Stm32ObjectSensor(const kitBase::robotModel::DeviceInfo &info
