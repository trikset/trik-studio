...
class Stm32GamepadConnectionIndicator : public kitBase::robotModel::robotParts::ScalarSensor
{
	Q_OBJECT
...
public:
	...
	Stm32GamepadConnectionIndicator(const kitBase::robotModel::DeviceInfo &info
