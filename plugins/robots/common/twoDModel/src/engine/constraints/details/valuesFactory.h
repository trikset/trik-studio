...
private:
	QVariant propertyChain(const QVariant &value, const QStringList &properties, const QString &objectAlias,
		bool errorOnNotFound = true) const;
	QVariant propertyOf(const QVariant &value, const QString &property, const QString &objectAlias,
		bool errorOnNotFound = true) const;
	QVariant propertyOf(const QVariant &value, const QString &property, bool *hasProperty = nullptr,
		bool *unknownType = nullptr) const;
	...
	QVariant propertyOf(QRect rect, const QString &property, bool *ok = nullptr) const;
