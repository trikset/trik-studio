...
void RobotsBlock::init(const Id &graphicalId, const GraphicalModelAssistInterface *graphicalModelApi,
...
void RobotsBlock::init(const qReal::Id &graphicalId, const qReal::GraphicalModelAssistInterface *graphicalModelApi,
	const qReal::LogicalModelAssistInterface *logicalModelApi, qReal::ErrorReporterInterface *const errorReporter,
	qrtext::LanguageToolboxInterface *textLanguageToolbox)
{
