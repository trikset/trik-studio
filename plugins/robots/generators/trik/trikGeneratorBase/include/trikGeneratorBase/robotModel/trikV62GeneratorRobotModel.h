...
class ROBOTS_TRIK_GENERATOR_BASE_EXPORT TrikV62GeneratorRobotModel : public TrikRobotModelV62,
								     public GeneratorModelExtensionInterface
{
	Q_OBJECT

public:
	TrikV62GeneratorRobotModel(const QString &kitId, const QString &robotId, const QString &name,
