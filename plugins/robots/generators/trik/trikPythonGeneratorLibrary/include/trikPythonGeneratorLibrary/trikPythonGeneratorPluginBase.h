...
/// Generation of Python program for TRIK, uploading and execution of a program.
/// Uses setting "tcpServer" from RobotsInterpreter.
class TrikPythonGeneratorPluginBase : public TrikGeneratorPluginBase
{
	Q_OBJECT

public:
	TrikPythonGeneratorPluginBase(trik::robotModel::TrikRobotModelBase * const robotModel
			, const QSharedPointer<kitBase::blocksBase::BlocksFactoryInterface> &blocksFactory
			, const QStringList &pathsToTemplates);

	~TrikPythonGeneratorPluginBase() override;
