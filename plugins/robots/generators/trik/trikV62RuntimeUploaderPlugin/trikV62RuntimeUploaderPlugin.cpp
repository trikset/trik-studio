...
const QStringList commands = {createTrikDirectory, removePermissions, killTrikGui, moveCommand, replaceTrikGuiSh,
	restoreTrikGuiShPermissions, restorePermissions, restartTrikGui};
...
TrikV62RuntimeUploaderPlugin::TrikV62RuntimeUploaderPlugin()
	: mUploaderTool(tr("Upload Runtime"), ":/trik/images/flashRobot.svg", "trikV62Kit", commands,
