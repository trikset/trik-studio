...
SwitchConditionsMerger::SwitchConditionsMerger(const QStringList &pathsToTemplates,
	const ConverterInterface *const systemVariablesConverter, const QStringList &values, bool generateIf)
...
QString SwitchConditionsMerger::convert(const QString &expression) const
{
	...
	const QString conditionsSeparatorFile =
		mGenerateIf ? "switch/conditionsSeparator.t" : "switch/conditionsSeparator_switch.t";
