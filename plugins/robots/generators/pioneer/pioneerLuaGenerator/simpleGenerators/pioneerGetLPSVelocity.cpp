...
#include "pioneerGetLPSVelocity.h"
...
PioneerGetLPSVelocity::PioneerGetLPSVelocity(const qrRepo::RepoApi &repo
		, generatorBase::GeneratorCustomizer &customizer
		, const qReal::Id &id
		, QObject *parent)
	: BindingGenerator(repo, customizer, id, "quadcopterCommands/getLPSVelocity.t"
		, {
