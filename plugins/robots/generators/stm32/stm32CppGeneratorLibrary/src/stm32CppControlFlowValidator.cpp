...
Stm32CppControlFlowValidator::Stm32CppControlFlowValidator(const qrRepo::RepoApi &repo
...
bool Stm32CppControlFlowValidator::validate(const qReal::Id &diagramId, const QString &threadId)
{
	mDiagram = diagramId;
	findInitialNode();
...
PrimaryControlFlowValidator *Stm32CppControlFlowValidator::clone()
{
	return new Stm32CppControlFlowValidator(mRepo, mErrorReporter, mCustomizer, parent());
}
