...
Stm32CppGeneratorPluginBase::Stm32CppGeneratorPluginBase(
...
void Stm32CppGeneratorPluginBase::init(const kitBase::KitPluginConfigurator &configurer)
{
	...
	connect(mUploadProgramProtocol.data(), &UploadProgramProtocol::error
	        , this, &Stm32CppGeneratorPluginBase::onProtocolFinished);
...
QList<ActionInfo> Stm32CppGeneratorPluginBase::customActions()
{
...
QList<HotKeyActionInfo> Stm32CppGeneratorPluginBase::hotKeyActions()
{
...
QIcon Stm32CppGeneratorPluginBase::iconForFastSelector(const RobotModelInterface &robotModel) const
{
	Q_UNUSED(robotModel)
...
generatorBase::MasterGeneratorBase *Stm32CppGeneratorPluginBase::masterGenerator()
{
...
QString Stm32CppGeneratorPluginBase::defaultFilePath(const QString &projectName) const
{
	return QString("stm32/%1/%1.cpp").arg(projectName);
}

text::LanguageInfo Stm32CppGeneratorPluginBase::language() const
{
	return qReal::text::Languages::c({"brick"});
}

QString Stm32CppGeneratorPluginBase::generatorName() const
{
	return "stm32Cpp";
}

void Stm32CppGeneratorPluginBase::addShellDevice(robotModel::GeneratorModelExtensionInterface &robotModel) const
{
...
void Stm32CppGeneratorPluginBase::uploadProgram()
{
...
void Stm32CppGeneratorPluginBase::runProgram()
{
	uploadProgram();
//	const QFileInfo fileInfo = generateCodeForProcessing();
...
void Stm32CppGeneratorPluginBase::stopRobot()
{
...
void Stm32CppGeneratorPluginBase::onProtocolFinished()
{
...
void Stm32CppGeneratorPluginBase::disableButtons()
{
