...
class Stm32CppGeneratorPluginBase : public Stm32GeneratorPluginBase
{
	Q_OBJECT

public:
	Stm32CppGeneratorPluginBase(stm32::robotModel::Stm32RobotModelBase * const robotModel
			, kitBase::blocksBase::BlocksFactoryInterface * const blocksFactory
			, const QStringList &pathsToTemplates);

	~Stm32CppGeneratorPluginBase() override;
