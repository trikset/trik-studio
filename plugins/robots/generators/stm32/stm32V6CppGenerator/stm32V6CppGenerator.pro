...
TARGET = robots-stm32-v6-cpp-generator
...
TRANSLATIONS = \
	$$PWD/../../../../../qrtranslations/ru/plugins/robots/stm32V6CppGenerator_ru.ts \
	$$PWD/../../../../../qrtranslations/fr/plugins/robots/stm32V6CppGenerator_fr.ts \

HEADERS += \
	$$PWD/stm32V6CppGeneratorPlugin.h \

SOURCES += \
	$$PWD/stm32V6CppGeneratorPlugin.cpp \

RESOURCES += \
	$$PWD/stm32V6CppTemplates.qrc \
