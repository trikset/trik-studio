...
Stm32MasterGeneratorBase::Stm32MasterGeneratorBase(const qrRepo::RepoApi &repo
...
generatorBase::GeneratorCustomizer *Stm32MasterGeneratorBase::createCustomizer()
{
	return new Stm32GeneratorCustomizer(mRepo, mErrorReporter
