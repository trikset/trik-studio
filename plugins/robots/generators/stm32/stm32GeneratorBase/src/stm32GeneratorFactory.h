...
/// Generator factory implemtation for STM32 platform
class Stm32GeneratorFactory : public generatorBase::GeneratorFactoryBase
{
public:
	Stm32GeneratorFactory(const qrRepo::RepoApi &repo
			, qReal::ErrorReporterInterface &errorReporter
			, const kitBase::robotModel::RobotModelManagerInterface &robotModelManager
			, generatorBase::lua::LuaProcessor &luaProcessor
			, const QStringList &pathsToTemplates);

	~Stm32GeneratorFactory() override;
