...
class ROBOTS_STM32_GENERATOR_BASE_EXPORT Stm32V6GeneratorRobotModel
		: public Stm32RobotModelV6
		, public GeneratorModelExtensionInterface
{
	Q_OBJECT

public:
	Stm32V6GeneratorRobotModel(const QString &kitId, const QString &robotId
