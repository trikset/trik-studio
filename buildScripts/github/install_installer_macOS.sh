...
BIN_DIR="/Applications/TRIKStudio/TRIK Studio.app/" && echo "BIN_DIR=$BIN_DIR" >> $GITHUB_ENV
LIB_DIR="/Applications/TRIKStudio/TRIK Studio.app/Lib" && echo "LIB_DIR=$LIB_DIR" >> $GITHUB_ENV
APP_DIR="/Applications/TRIKStudio" && echo "APP_DIR=$APP_DIR" >> $GITHUB_ENV

ls "/Applications/TRIKStudio/TRIK Studio.app"
