...
case "$(uname)" in
  Darwin)
    ...
    test -r "$D" || curl -L -o "$D" "https://download.qt-project.org/official_releases/qt-installer-framework/$QTIFW_VERSION/QtInstallerFramework-macOS-x64-${QTIFW_VERSION}.dmg"
