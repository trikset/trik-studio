...
public:
	...
	void configureBroadly(QString const &robotModel, kitBase::robotModel::PortInfo const &port,
...
protected:
	void onDeviceConfigurationChanged(QString const &robotModel, kitBase::robotModel::PortInfo const &port,
