...
public:
	...
	MOCK_METHOD2(block, qReal::interpretation::BlockInterface *(qReal::Id const &element,
				    kitBase::robotModel::RobotModelInterface const &robotModel));
	MOCK_CONST_METHOD1(enabledBlocks, QSet<qReal::Id>(kitBase::robotModel::RobotModelInterface const &robotModel));
	MOCK_CONST_METHOD1(visibleBlocks, QSet<qReal::Id>(kitBase::robotModel::RobotModelInterface const &robotModel));
