...
<context>
    ...
    <message>
        ...
        <translation>Считывает значение в переменную из диалового окна ввода.</translation>
    </message>
    <message>
        <location line="+104"/>
        <location line="+450"/>
    ...
    <message>
        ...
        <translation>Блок с текстовыми заметками, которые игнорируются при генерации и интерпретации. Используйте его для улучшения читаемости диаграммы.</translation>
    </message>
    <message>
        <location line="+35"/>
    ...
    <message>
        ...
        <translation>Чтобы создать связь между двумя элементами A и B, можно навести курсор мыши на элемент A, нажать правую кнопку мыши и, не отпуская ее, провести линию к элементу B. Также можно «вытащить» связь из синего кружка рядом с элементом.</translation>
    </message>
    <message>
        <location line="+47"/>
        <source>Guard</source>
    ...
    <message>
        ...
        <translation>Вычисляет значение заданного выражения. Также в данном блоке допускается определение новых переменных. Дополнительная информация о синтаксисе допустимых выражений параметра «Функция» доступна в документации в разделе «Синтаксис выражений».</translation>
    </message>
    <message>
        <source>Body</source>
    ...
    <message>
        ...
        <translation>Присваивает заданной переменной значение нажатой кнопки. Если в данный момент нет нажатых кнопок и свойство «Дождаться нажатия» ложно, переменная будет иметь значение -1.</translation>
    </message>
    <message>
        <location line="+39"/>
        <location line="+151"/>
    ...
    <message>
        ...
        <translation>Разделить выполнение программы в соответствии с заданным условием. Значением параметра «Условие» должно являться некое логическое выражение, которое будет определять последующий участок выполнения программы. У данного блока должны быть две исходящие связи, как минимум у одной из которых должно быть задано значение параметра «Условие» (возможные варианты — «истина» и «ложь»). Выполнение будет проходить по связи, помеченной условием, соответствующим параметру «Условие» этого блока.</translation>
    </message>
    <message>
        <location line="+32"/>
        <location line="+353"/>
    ...
    <message>
        ...
        <translation>Начальная точка выполнения программы. На каждой диаграмме должен быть только один такой блок; у него не должно быть входящих связей и исходящая связь должна быть только одна. Процесс интерпретации диаграммы начинается именно с этого блока.</translation>
    </message>
    <message>
        <location line="+41"/>
    ...
    <message>
        ...
        <translation>Объединяет несколько задач в одну. Свойство «Условие» единственной исходящей связи должно содержать идентификатор одной из объединяемых задач. Выполнение указанной задачи приостановится до того момента, как остальные задачи завершат выполнение, а затем выполнение продолжится в обычном порядке.</translation>
    </message>
    <message>
        <location line="+33"/>
    ...
    <message>
        ...
        <translation>Завершает выполнение указанной задачи.</translation>
    </message>
    <message>
        <location line="+31"/>
        <source>Thread</source>
    ...
    <message>
        ...
        <translation>Опускает маркер робота в 2D модели на пол так, что тот начинает рисовать на полу свою траекторию. Если маркер другого цвета уже рисует в этот момент, то он будет заменён.</translation>
    </message>
    <message>
        <location line="+42"/>
    ...
    <message>
        ...
        <translation>Поднимает маркер робота в 2D модели так, что тот перестаёт рисовать свою траекторию на полу.</translation>
    </message>
    <message>
        <location line="+33"/>
    ...
    <message>
        ...
        <translation>Печатает заданную строку в указанных координатах на экране робота. Значение свойства «Текст» интерпретируется как обычный текст, если только  для свойства «Вычисление» не задано значение true — в этом случае оно будет интерпретироваться как выражение (это может быть полезно, например, при отладке значений переменных).</translation>
    </message>
    <message>
        <location line="+47"/>
    ...
    <message>
        ...
        <translation>Случайная инициализация</translation>
    </message>
    <message>
        <location line="+2"/>
        <source>Sets a variable value to a random value inside given interval.</source>
        <translation>Присваивает переменной случайное значение из заданного интервала.</translation>
    </message>
    <message>
        <location line="+47"/>
        <source>From</source>
    ...
    <message>
        ...
        <translation>Получить сообщение от другой задачи</translation>
    </message>
    <message>
        <location line="+2"/>
        <source>Receive a message sent to a thread from which this block is called.</source>
        <translation>Получить сообщение, отправленное другой задачей той задаче, из которой вызван этот блок.</translation>
    </message>
    <message>
        <location line="+39"/>
        <source>Synchronized</source>
    ...
    <message>
        ...
        <translation>Отправить сообщение задаче</translation>
    </message>
    <message>
        <location line="+2"/>
        <source>Sends a message to a specified thread.</source>
        <translation>Отправляет сообщение указанной задаче.</translation>
    </message>
    <message>
        <source>Message</source>
    ...
    <message>
        ...
        <translation>Выбирает ветку выполнения программы в соответствии со значением выражения. Значение выражения, указанного в свойстве «Выражение», сравнивается со значениями на исходящих связях. Если среди них будет найдено равное, выполнение будет продолжено по этой ветке. В противном случае будет выбрана ветка без маркера.</translation>
    </message>
    <message>
        <location line="-887"/>
        <location line="+918"/>
    ...
    <message>
        ...
        <translation>Блок позволяет выполнить последовательность блоков, пока указанное в свойстве «Условие» условие является истинным. Блок должен иметь две исходящие связи, одна из которых должна быть помечена значением «тело цикла» (то есть значением параметра «Условие» должно быть «тело цикла»). Другая исходящая связь должна оставаться непомеченной: по ней будет осуществляться переход, когда условие станет ложным.</translation>
    </message>
    <message>
        <location line="+475"/>
        <source>Timer</source>
    ...
    <message>
        ...
        <translation>Присвоить заданное значение заданной переменной.</translation>
    </message>
    <message>
        <location line="+39"/>
        <source>Value</source>
