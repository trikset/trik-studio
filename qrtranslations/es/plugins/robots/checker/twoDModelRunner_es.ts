...
In background mode the session will be terminated just after the execution ended and return code will then contain binary information about program correctness.Example: 
        ...
        <translation>Emula el comportamiento del robot en el modelo 2D de TRIK Studio independientemente del entorno de programación. El archivo .qrs proporcionado será interpretado como si se hubiera pulsado el botón &apos;Ejecutar&apos; en TRIK Studio. 
En modo de fondo, la sesión finalizará inmediatamente tras la ejecución, y el código de retorno contendrá información binaria sobre la corrección del programa. Ejemplo: 
</translation>
    </message>
    <message>
