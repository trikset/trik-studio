...
In background mode the session will be terminated just after the execution ended and return code will then contain binary information about program correctness.Example: 
        ...
        <translation>Mô phỏng hành vi của robot trên mô hình 2D của TRIK Studio độc lập với môi trường lập trình. Tập tin .qrs được truyền vào sẽ được thông dịch giống như khi nhấn nút &apos;Chạy&apos; trong TRIK Studio. 
Ở chế độ nền, phiên làm việc sẽ tự động kết thúc ngay sau khi thực thi xong, và mã trả về sẽ chứa thông tin nhị phân về tính đúng đắn của chương trình. Ví dụ: 
</translation>
    </message>
    <message>
