...
public:
	...
	ChangePropertyCommand(models::LogicalModelAssistApi *const model, const QString &property, const Id &id,
		const QVariant &newValue);

	/// Use this overload to modify properties via models api with manual old value specification.
	ChangePropertyCommand(qrRepo::LogicalRepoApi *const model, const QString &property, const Id &id,
