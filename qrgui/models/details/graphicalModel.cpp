...
{
	Q_ASSERT_X(mModelItems.contains(elementInfo.graphicalParent()), Q_FUNC_INFO,
...
void GraphicalModel::initializeElement(const ElementInfo &elementInfo, AbstractModelItem *parentItem,
